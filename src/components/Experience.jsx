  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const result = await emailjs.sendForm(
        'service_z1oevfo', // Your EmailJS service ID
        'template_h7fl9m3', // Your EmailJS template ID
        form.current,
        'KaGosDyNdQNGt16Oq' // Your EmailJS public key (optional if already initialized)
      );
